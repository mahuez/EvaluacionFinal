...
<br/>
 <div class="container">
 	<br>
    <br>
    <!--<c:forEach items="${lcliente}" var="mycli">  </c:forEach>  -->
    <h2>Editar Cliente</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesaeditacliente' method="POST">
			<div class="mb-3">
				<label for="rutcliente" class="form-label">Rut cliente</label> 
				<input type="text" class="form-control" id="rutcliente"  value='<c:out value="${mycli.getRutcliente()}"/>'  name="rutcliente" placeholder="123456789">
			</div>
			<div class="mb-3">
				<label for="clinombres" class="form-label">Nombres</label> 
				<input type="text" class="form-control" id="clinombres" value='<c:out value="${mycli.getClinombres()}"/>' name="clinombres" placeholder="Sebastian Luis">
			</div>
			<div class="mb-3">
				<label for="cliapellidos" class="form-label">Apellidos</label> 
				<input type="text" class="form-control" id="cliapellidos" value='<c:out value="${mycli.getCliapellidos()}"/>' name="cliapellidos" placeholder="Lopez Perez">
			</div>
			<div class="mb-3">
				<label for="clitelefono" class="form-label">Telefono</label> 
				<input type="text" class="form-control" id="clitelefono" value='<c:out value="${mycli.getClitelefono()}"/>' name="clitelefono" placeholder="658967412">
			</div>
			<div class="mb-3">
				<label for="cliafp" class="form-label">A.F.P</label> 
				<input type="text" class="form-control" id="cliafp" value='<c:out value="${mycli.getCliafp()}"/>' name="cliafp" placeholder="Modelo">
			</div>
						<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="clidireccion" value='<c:out value="${mycli.getClidireccion()}"/>' name="clidireccion" placeholder="Av.Brasil 123">
			</div>
			<div class="mb-3">
				<label for="clicomuna" class="form-label">Comuna</label> 
				<input type="text" class="form-control" id="clicomuna" value='<c:out value="${mycli.getClicomuna()}"/>' name="clicomuna" placeholder="Providencia">
			</div>
			<div class="mb-3">
				<label for="cliedad" class="form-label">Edad</label> 
				<input type="text" class="form-control" id="cliedad" value='<c:out value="${mycli.getCliedad()}"/>' name="cliedad" placeholder="35">
			</div>
