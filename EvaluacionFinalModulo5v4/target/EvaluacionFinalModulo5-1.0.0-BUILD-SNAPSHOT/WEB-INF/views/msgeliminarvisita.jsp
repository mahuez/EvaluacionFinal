		...
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<table class="table table-bordered">
					<tr>
						<td><p>La visita ha sido eliminada exitosamente!!!</p></td>
					</tr>
				</table>

				<br /> 
				<br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarvisita'>Volver al listado de visitas</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listaradministrativo' class="btn btn-primary">Crear nueva visita</a>
			</div>
		</div>
	</div>
</body>
