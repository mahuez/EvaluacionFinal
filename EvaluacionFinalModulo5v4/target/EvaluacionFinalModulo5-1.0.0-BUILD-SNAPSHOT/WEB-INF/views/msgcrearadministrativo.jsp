...
<link rel="stylesheet"
	href='<c:out value="${pageContext.request.contextPath}"/>/resources/css/estilos.css' />
<link rel="stylesheet"
	href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta1/dist/css/bootstrap.min.css">
<link rel="preconnect" href="https://fonts.gstatic.com">
<link rel="stylesheet"
	href="https://fonts.googleapis.com/css2?family=Questrial&family=Sansita+Swashed&display=swap">
...
<script
	src='<c:out value="${pageContext.request.contextPath}"/>/resources/js/JavaScript.js'></script>
</head>
<body>
	<header>
		<div class="menu_bar">
	...
	<div class="container">
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<br>
				<br> <a
					href='<c:out value= "${pageContext.request.contextPath}"/>/listarusuario'>Volveral Listado de usuario</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listaradministrativo' class="btn btn-primary">Ir al Listado de Administrativo</a>
			</div>
		</div>
	</div>
</body>
