...
<br/>
	<div class="container">
				...
				<c:forEach items="${lcapacitacion}" var="lc">
					<tr>
						...
						<td>
							...
							<a href='<c:out value="${pageContext.request.contextPath}" />/eliminarcapacitacion/<c:out value="${lc.getIdcapacitacion()}" />'><i class="fas fa-trash-alt"  title="Eliminar"></i></a>
							&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/editarcapacitacion/<c:out value="${lc.getIdcapacitacion()}" />'><i class="fas fa-user-edit"  title="Editar"></i></a>
							&nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/detallecapacitacion/<c:out value="${lc.getIdcapacitacion()}" />'><i class="far fa-file-archive"  title="Detalle"></i></a>
		...
		<a href= '<c:out value= "${pageContext.request.contextPath}"/>/crearcapacitacion' class="btn btn-primary">Crear Capacitacion</a>
	</div>
	<br/>
	<br/>
