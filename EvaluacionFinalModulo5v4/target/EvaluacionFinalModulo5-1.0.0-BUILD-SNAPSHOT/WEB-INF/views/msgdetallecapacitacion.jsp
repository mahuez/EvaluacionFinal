...
<title>Detalle de capacitacion</title>
	...
	<div class="container">
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				<h2>Detalle de la capacitacion</h2>
				<br />
				<table class="table table-bordered">
					...
					<tr>
						<th>Fecha:</th>
						<td><c:out value="${capa.getCapfecha()}" /></td>
					</tr>

					<tr>
						<th>Hora:</th>
						<td><c:out value="${capa.getCaphora()}" /></td>
					</tr>

					<tr>
						<th>Lugar:</th>
						<td><c:out value="${capa.getCaplugar()}" /></td>
					</tr>

					<tr>
						<th>Duracion:</th>
						<td><c:out value="${capa.getCapduracion()}" /></td>
					</tr>

					<tr>
						<th>Rut cliente:</th>
						<td><c:out value="${capa.getCliente_rutcliente()}" /></td>
					</tr>
