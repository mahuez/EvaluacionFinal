	...
	<div class="container">
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<br /> 
				<br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarvisita' class="btn btn-primary">Ir al Listado de visitas</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/crearvisita' class="btn btn-primary">Crear nueva visita</a>
