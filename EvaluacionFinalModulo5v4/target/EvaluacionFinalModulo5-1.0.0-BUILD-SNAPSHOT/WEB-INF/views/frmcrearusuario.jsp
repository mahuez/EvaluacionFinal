...
<br/>
<div class="container">
		 	<h2>Ingrese datos de Usuario</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesarcrearusuario' method="POST">
			<div class="mb-3">
				<label for="nombre" class="form-label">Nombre</label> 
				<input type="text" class="form-control" id="nombre"  name="nombre" placeholder="Aquiles ">
			</div>
			<div class="mb-3">
				<label for="apellido" class="form-label">Apellido</label> 
				<input type="text" class="form-control" id="apellido" name="apellido" placeholder="Brinco">
			</div>
			<div class="mb-3">
				<label for="fechanacimiento" class="form-label">Fecha de nacimiento</label> 
				<input type="date" class="form-control" id="fechanacimiento" name="fechanacimiento" placeholder="16/08/1991">
			</div>
			<div class="mb-3">
				<label for="runusu" class="form-label">Run</label> 
				<input type="text" class="form-control" id="runusu" name="runusu" placeholder="123456789">
			</div>
