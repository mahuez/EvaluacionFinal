...
<br/>
 <div class="container">
 	<br>
    <br>
    <h2>Crear Profesional</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesarcrearprofesional' method="POST">
			<div class="mb-3">
				<label for="runprof" class="form-label">Run profesional</label> 
				<input type="text" class="form-control" id="runprof"  name="runprof" placeholder="123456789">
			</div>
			<div class="mb-3">
				<label for="nombres" class="form-label">Nombres</label> 
				<input type="text" class="form-control" id="nombres" name="nombres" placeholder="Sebastian Luis">
			</div>
			<div class="mb-3">
				<label for="apellidos" class="form-label">Apellidos</label> 
				<input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Lopez Perez">
			</div>
			<div class="mb-3">
				<label for="telefono" class="form-label">Telefono</label> 
				<input type="text" class="form-control" id="telefono" name="telefono" placeholder="658967412">
			</div>
			<div class="mb-3">
				<label for="tituloprofesional" class="form-label">Titulo profesional</label> 
				<input type="text" class="form-control" id="tituloprofesional" name="tituloprofesional" placeholder="Ingeniero civil">
			</div>
			<div class="mb-3">
				<label for="proyecto" class="form-label">Proyecto</label> 
				<input type="text" class="form-control" id="proyecto" name="proyecto" placeholder="Puentes">
			</div>
			<div class="mb-3">
				<label for="usuario_runusu" class="form-label">Rut usuario</label> 
				<input type="text" class="form-control" id="usuario_runusu" value='<c:out value="${myusu.getUsuario_runusu()}"/>' name="usuario_run">
			</div>
