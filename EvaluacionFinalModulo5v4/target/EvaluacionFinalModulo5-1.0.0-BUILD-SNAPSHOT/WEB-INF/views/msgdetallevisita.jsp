...
<title>Detalle de la visita</title>
		...
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<table class="table table-bordered">
					<tr>
						<th>Id Visita:</th>
						<td><c:out value="${visi.getIdvisita()}" /></td>
					</tr>

					<tr>
						<th>Fecha:</th>
						<td><c:out value="${visi.getVisfecha()}" /></td>
					</tr>

					<tr>
						<th>Hora:</th>
						<td><c:out value="${visi.getVishora()}" /></td>
					</tr>

					<tr>
						<th>Lugar:</th>
						<td><c:out value="${visi.getVislugar()}" /></td>
					</tr>

					<tr>
						<th>Comentarios:</th>
						<td><c:out value="${visi.getViscomentarios()}" /></td>
					</tr>

					<tr>
						<th>Rut Cliente:</th>
						<td><c:out value="${visi.getCliente_rutcliente()}" /></td>
					</tr>

				</table>

				<br /> <br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarvisita' class="btn btn-primary">Volver al Listado de visitas</a>
			</div>
		</div>
	</div>
</body>
