	...
	<div class="container">
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<br /> 
				<br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarpagos' class="btn btn-primary">Ir al Listado de pagos</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/crearpagos' class="btn btn-primary">Crear nuevo pago</a>
			</div>
		</div>
	</div>	
</body>
