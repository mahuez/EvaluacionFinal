...
<br/>
	<div class="container">
		...
		<table class="table">
			...
			<tbody>
				<c:forEach items="${lvisita}" var="lvi">
					<tr>
						<td><c:out value="${lvi.getIdvisita()}" /></td>
						<td><c:out value="${lvi.getVisfecha()}" /></td>
						<td><c:out value="${lvi.getVishora()}" /></td>
						<td><c:out value="${lvi.getVislugar()}" /></td>
						<td><c:out value="${lvi.getViscomentarios()}" /></td>
						<td><c:out value="${lvi.getCliente_rutcliente()}" /></td>
						<td>
						
							<a href='<c:out value="${pageContext.request.contextPath}" />/eliminarvisita/<c:out value="${lvi.getIdvisita()}" />'><i class="fas fa-trash-alt"  title="Eliminar"></i></a>
							&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/editarvisita/<c:out value="${lvi.getIdvisita()}" />'><i class="fas fa-user-edit"  title="Editar"></i></a>
							&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/detallevisita/<c:out value="${lvi.getIdvisita()}" />'><i class="far fa-file-archive"  title="Detalle"></i></a>
		...
		<a href= '<c:out value= "${pageContext.request.contextPath}"/>/crearvisita'>Crear Visita</a>
	</div>
	<br/>
	<br/>
