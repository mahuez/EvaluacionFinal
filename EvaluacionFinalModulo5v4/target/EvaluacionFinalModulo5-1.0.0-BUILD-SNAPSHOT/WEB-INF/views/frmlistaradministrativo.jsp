...
<title>Listar Administrativos</title>
	...
	<div class="container">
		...
		<table class="table">
			<thead class="table-dark">
				<tr>
					<th scope="col">Run Administrativo</th>
			...
			<tbody>
				<c:forEach items="${ladministrativo}" var="la">
					<tr>
						<td><c:out value="${la.getRunadmin()}" /></td>
						<td><c:out value="${la.getNombres()}" /></td>
						<td><c:out value="${la.getApellidos()}" /></td>
						<td><c:out value="${la.getEmail()}" /></td>
						<td><c:out value="${la.getArea()}" /></td>
						<td><c:out value="${la.getUsuario_runusu()}" /></td>
						<td>
						
							<a href='<c:out value="${pageContext.request.contextPath}" />/eliminaradministrativo/<c:out value="${la.getRunadmin()}" />'><i class="fas fa-trash-alt"  title="Eliminar"></i></a>
							&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/editaradministrativo/<c:out value="${la.getRunadmin()}" />'><i class="fas fa-user-edit"  title="Editar"></i></a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
