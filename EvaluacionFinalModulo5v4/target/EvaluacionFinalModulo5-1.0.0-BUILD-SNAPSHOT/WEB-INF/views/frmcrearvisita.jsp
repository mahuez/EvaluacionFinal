...
<br/>
 <div class="container">
 	<br>
    <br>
    <h2>Crear Visita</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesarcrearvisita' method="POST">
			<div class="mb-3">
				<label for="idvisita" class="form-label">ID</label> 
				<input type="text" class="form-control" id="idvisita" name="idvisita" placeholder="101">
			</div>
			<div class="mb-3">
				<label for="visfecha" class="form-label">Fecha</label> 
				<input type="date" class="form-control" id="visfecha" name="visfecha" placeholder="06/12/21">
			</div>
			<div class="mb-3">
				<label for="vishora" class="form-label">Hora</label> 
				<input type="time" class="form-control" id="vishora" name="vishora" placeholder="15:30">
			</div>
			<div class="mb-3">
				<label for="vislugar" class="form-label">Lugar</label> 
				<input type="text" class="form-control" id="vislugar" name="vislugar" placeholder="Providencia">
			</div>
			<div class="mb-3">
				<label for="viscomentarios" class="form-label">Comentario</label> 
				<input type="text" class="form-control" id="viscomentarios" name="viscomentarios" placeholder="Peligro de derrumbe">
			</div>
			<div class="mb-3">
				<label for="cliente_rutcliente" class="form-label">Rut Cliente</label> 
				<input type="text" class="form-control" id="cliente_rutcliente" value='<c:out value="${myvis.getCliente_rutcliente()}"/>' name="cliente_rutcliente">
			</div>
