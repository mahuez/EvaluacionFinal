...
<br/>
 <div class="container">
    ...
    <h2>Crear Pagos</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesarcrearpagos' method="POST">
			<div class="mb-3">
				<label for="idpagos" class="form-label">ID</label> 
				<input type="text" class="form-control" id="idpagos" name="idpagos" placeholder="01 , 02 , etc">
			</div>
			<div class="mb-3">
				<label for="fechapago" class="form-label">Fecha de pago</label> 
				<input type="date" class="form-control" id="fechapago" name="fechapago" placeholder="06/12/21">
			</div>
			<div class="mb-3">
				<label for="monto" class="form-label">Monto</label> 
				<input type="text" class="form-control" id="monto" name="monto" placeholder="150.000">
			</div>
			<div class="mb-3">
				<label for="mes" class="form-label">Mes</label> 
				<input type="text" class="form-control" id="mes" name="mes" placeholder="Agosto">
			</div>
			<div class="mb-3">
				<label for="año" class="form-label">Año</label> 
				<input type="text" class="form-control" id="año" name="año" placeholder="2019">
			</div>
			<div class="mb-3">
				<label for="cliente_rutcliente" class="form-label">Rut Cliente</label> 
				<input type="text" class="form-control" id="cliente_rutcliente" value='<c:out value="${lc.getRutcliente()}"/>' name="cliente_rutcliente">
			</div>
