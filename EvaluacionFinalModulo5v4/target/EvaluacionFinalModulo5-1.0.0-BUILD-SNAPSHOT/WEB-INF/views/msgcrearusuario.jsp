...
<header>
	...
	<section class="col-12">
		<a href='<c:out value="${pageContext.request.contextPath}" />/crearcliente/' class="btn btn-primary">Cliente</a>
		&nbsp; &nbsp; &nbsp; 
		<a href='<c:out value="${pageContext.request.contextPath}" />/crearprofesional/' class="btn btn-primary">Profesional</a>
		&nbsp; &nbsp; &nbsp; 
		<a href='<c:out value="${pageContext.request.contextPath}" />/crearadministrativo/' class="btn btn-primary">Administrativo</a>
	</section>
	
	<br><br>
	<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarusuario' class="btn btn-primary">Volver al listado de usuario</a>
			</div>
		</div>
	</div>
</body>
