...
<title>Listar Profesional</title>
	...
	<div class="container">
		...
		<table class="table">
			<thead class="table-dark">
				<tr>
					<th scope="col">Run Profesional</th>
			...
			<tbody>
				<c:forEach items="${lprofesional}" var="lp">
					<tr>
						<td><c:out value="${lp.getRunprof()}" /></td>
						<td><c:out value="${lp.getNombres()}" /></td>
						<td><c:out value="${lp.getApellidos()}" /></td>
						<td><c:out value="${lp.getTelefono()}" /></td>
						<td><c:out value="${lp.getTituloprofesional()}" /></td>
						<td><c:out value="${lp.getProyecto()}" /></td>
						<td><c:out value="${lp.getUsuario_runusu()}" /></td>
						<td>
							<a href='<c:out value="${pageContext.request.contextPath}" />/eliminarprofesional/<c:out value="${la.getRunprof()}" />'><i class="fas fa-trash-alt"  title="Eliminar"></i></a>
							&nbsp; &nbsp; &nbsp; | &nbsp; &nbsp; &nbsp; 
							<a href='<c:out value="${pageContext.request.contextPath}" />/editarprofesional/<c:out value="${la.getRunprof()}" />'><i class="fas fa-user-edit"  title="Editar"></i></a>
						</td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
		<a href= '<c:out value= "${pageContext.request.contextPath}"/>/crearadministrativo' class="btn btn-primary">Crear administrativo</a>
	</div>
	<br/>
	<br/>
