		...
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<table class="table table-bordered">
					<tr>
						<th>Id Pagos:</th>
						<td><c:out value="${pago.getIdpagos()}" /></td>
					</tr>

					<tr>
						<th>Fecha de pago:</th>
						<td><c:out value="${pago.getFechapago()}" /></td>
					</tr>

					<tr>
						<th>Monto:</th>
						<td><c:out value="${pago.getMonto()}" /></td>
					</tr>

					<tr>
						<th>Mes:</th>
						<td><c:out value="${pago.getMes()}" /></td>
					</tr>

					<tr>
						<th>Año</th>
						<td><c:out value="${pago.getAño()}" /></td>
					</tr>

					<tr>
						<th>Rut cliente:</th>
						<td><c:out value="${pago.getCliente_rutcliente()}" /></td>
					</tr>

				</table>

				<br /> <br /> 
				<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarpagos' class="btn btn-primary">Volver al listado de pago</a>
			</div>
		</div>
	</div>
</body>
