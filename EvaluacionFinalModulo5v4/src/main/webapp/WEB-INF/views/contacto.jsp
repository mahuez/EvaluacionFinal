    ...
    <div class="container-banner">
	 ...
	 <main>
        <section id="formulario">
            ...
            <form>
                <p>Nombre:
                <br><input type="text" name="nombre" size="40"></p>
                <p>Correo electrónico:
                <br><input type="email" name="correo" size="40"></p>   
                <p>Teléfono:
                <br><input type="tel" name="telefono" size="40"></p> 
                <p>Mensaje:
                <br><textarea name="mensaje" rows="8" cols="42"></textarea></p>
                <p>
