		...
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<table class="table table-bordered">
					<tr>
						<td><p>El pago ha sido eliminado exitosamente!!!</p></td>
					</tr>
				</table>

				<br /> 
				<br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarpagos'>Volver al listado de pagos</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/crearpago' class="btn btn-primary">Crear nuevo pago</a>
