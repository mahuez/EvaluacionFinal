		...
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				...
				<table class="table table-bordered">
					<tr>
						<td><p>El cliente ha sido eliminado exitosamente!!!</p></td>
					</tr>
				</table>
				...
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarcliente'>Volver al Listado de capacitacion</a>
