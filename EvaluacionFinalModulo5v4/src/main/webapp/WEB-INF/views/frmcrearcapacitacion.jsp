...
<br/>
 <div class="container">
 	<br>
    <br>
    <h2>Crear Capacitación</h2><br>
    	<form action='<c:out value= "${pageContext.request.contextPath}"/>/procesarcrear' method="POST">
			<div class="mb-3">
				<label for="idcapacitacion" class="form-label">ID</label> 
				<input type="number" class="form-control" id="idcapacitacion" name="idcapacitacion" placeholder="101">
			</div>
			<div class="mb-3">
				<label for="capfecha" class="form-label">Fecha</label> 
				<input type="date" class="form-control" id="capfecha" name="capfecha" placeholder="06/12/21">
			</div>
			<div class="mb-3">
				<label for="caphora" class="form-label">Hora</label> 
				<input type="time" class="form-control" id="caphora" name="caphora" placeholder="15:30">
			</div>
			<div class="mb-3">
				<label for="caplugar" class="form-label">Lugar</label> 
				<input type="text" class="form-control" id="caplugar" name="caplugar" placeholder="Providencia">
			</div>
			<div class="mb-3">
				<label for="capduracion" class="form-label">Duracion</label> 
				<input type="number" class="form-control" id="capduracion" name="capduracion" placeholder="120">
			</div>
			<div class="mb-3">
				<label for="cliente_rutcliente" class="form-label">Rut Cliente</label> 
				<input type="number" class="form-control" id="cliente_rutcliente" name="cliente_rutcliente"  >
			</div>
			
			 <div class="col-12">
    			<button type="submit" class="btn btn-primary">Crear Capacitacion</button>
  			</div>
		</form>
	</div>
	<br/>
