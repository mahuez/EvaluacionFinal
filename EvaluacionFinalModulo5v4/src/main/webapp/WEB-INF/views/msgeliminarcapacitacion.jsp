	...
	<div class="container">
		<div class="row justify-content-center align-items-center minh-100">
			<div class="w-50 p-3" style="background-color: #eee;">
				<h2>Eliminar Capacitacion</h2>
				<br />
				<table class="table table-bordered">
					<tr>
						<td><p>La capacitacion ha sido eliminada exitosamente!!!</p></td>
					</tr>
				</table>

				<br /> 
				<br /> 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarcapacitacion' class="btn btn-primary">Ir al Listado de capacitacion</a>
				&nbsp; &nbsp; &nbsp; 
					<a href='<c:out value= "${pageContext.request.contextPath}"/>/crearcapacitacion' class="btn btn-primary">Crear nueva capacitacion</a>
					
			</div>
		</div>
	</div>
	<a href='<c:out value= "${pageContext.request.contextPath}"/>/listarcapacitacion'>Volver al Listado de capacitacion</a>
